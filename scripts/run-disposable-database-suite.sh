...
case "$spec" in
  ...
  test/accounts/list-accounts.integration-spec.ts) ;;
  test/accounts/get-account.integration-spec.ts) ;;
  ...
  test/accounts/account-currency-invariant.integration-spec.ts) ;;
  test/identity/transactions-schema.integration-spec.ts) ;;
  test/identity/ledger-postings-schema.integration-spec.ts) ;;
  test/ledger/posting-currency-invariant.integration-spec.ts) ;;
  ...
  test/ledger/transactions-list.integration-spec.ts) ;;
  ...
  test/ledger/currency-exchanges-create.integration-spec.ts) ;;
  test/ledger/exchange-rates-schema.integration-spec.ts) ;;
